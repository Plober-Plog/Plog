...
## 8. 프로젝트 결과물(서비스 화면)
   ### 1. 홈화면
   <img src="./img/pages/홈화면/홈화면.jpg" width=300 height=650 ><br>
   
   ### 2. 비회원 화면
   <img src="./img/pages/비회원/비회원1.jpg" width=300 height=650>
   <img src="./img/pages/비회원/비회원2.jpg" width=300 height=650>
   <img src="./img/pages/비회원/비회원3.jpg" width=300 height=650><br>

   ### 3. 로그인 화면
   <img src="./img/pages/로그인/로그인1.jpg" width=300 height=650><br>

   ### 4. 회원가입 화면
   <img src="./img/pages/회원가입/회원가입1.jpg" width=300 height=650>
   ...
   ### 6. 프로필
   <img src="./img/pages/프로필/프로필1.jpg" width=300 height=650>
   ...
   ### 7. 식물 디테일
   <img src="./img/pages/식물디테일/식물디테일1.jpg" width=300 height=650>
   ...
   ### 8. 채팅
   <img src="./img/pages/채팅/채팅1.jpg" width=300 height=650>
   <img src="./img/pages/채팅/채팅2.jpg" width=300 height=650><br>
   
   ### 9. 알림창
   <img src="./img/pages/알림창/알림창1.jpg" width=300 height=650><br>
